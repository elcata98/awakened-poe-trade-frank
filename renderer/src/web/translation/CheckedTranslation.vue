...
import TradeListing from '../price-check/trade/TradeListing.vue'
import TradeBulk from '../price-check/trade/TradeBulk.vue'
import TradeLinks from '../price-check/trade/TradeLinks.vue'
// import { apiToSatisfySearch, getTradeEndpoint } from './trade/common'
import PriceTrend from '../price-check/trends/PriceTrend.vue'
import FiltersBlock from '../price-check/filters/FiltersBlock.vue'
// import { createPresets } from './filters/create-presets'
import PricePrediction from '../price-check/price-prediction/PricePrediction.vue'
import StackValue from '../price-check/stack-value/StackValue.vue'
import FilterName from '../price-check/filters/FilterName.vue'
...
import { TranslationWidget } from '../overlay/interfaces'
...
export default defineComponent({
  ...
  setup (props) {
    const widget = computed(() => AppConfig<TranslationWidget>('translation')!)
